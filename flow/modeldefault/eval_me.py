...
if __name__=='__main__':
	...
	work_dir = '.'
	lmdb_dir = os.path.join(work_dir, '../camvid200200_lmdb')
	deploy_file = os.path.join(work_dir, 'deploy.prototxt')
	snapshot = os.path.join(work_dir, 'snapshots_camvid200200/train_lr1e-10_77000_1e-11/_iter_{snapshot_id}.caffemodel')
	iter = range(75000, 74000, -1000)
