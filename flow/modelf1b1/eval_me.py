...
if __name__=='__main__':
	...
	work_dir = '.'
	lmdb_dir = os.path.join(work_dir, 'camvidfmp200200f1b1_lmdb')
	deploy_file = os.path.join(work_dir, 'deploy.prototxt')
	snapshot = os.path.join(work_dir, 'snapshots_camvidfmp200200f1b1/train_lr1e-14/_iter_{snapshot_id}.caffemodel')
	...
	print pred_visual_dir_template
