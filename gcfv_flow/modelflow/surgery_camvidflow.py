...
caffemodel_file = '/lustre/yixi/face_segmentation_finetune/flow/modelflownp/snapshots_camvidfmp200200epicflow/modeldefaultflowsurg_lr1e-10/_iter_38000.caffemodel'

net = caffe.Net('/lustre/yixi/face_segmentation_finetune/flow/modelflownp/deploy.prototxt', 
                caffemodel_file, caffe.TEST)

net_full_conv = caffe.Net('deploy_modeldefault.prototxt', caffemodel_file, caffe.TEST)
...
net_full_conv.save('camvidflow_surg.caffemodel')
